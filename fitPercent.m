function fit = fitPercent(p,Simulator,Exp,expToUse,outputToUse) 
%
...
for outputIdx = outputToUse
    ...
    SST = (N - 1)*var(data);
    fit(outputIdx) = 100*(1 - sqrt(SSE/SST)); % normalized root mean squared error 
end
