function vals = estimation_Objective(p,Simulator,Exp,expToUse,outputToUse,lambda,isOutputVector,Woutput) 
%
...
for expIdx = expToUse
    ...
    for outputIdx = outputToUse
        ...
        errorSeq = Woutput(outputIdx)*evalRequirement(r,OutputLog.Values,Exp(expIdx).OutputData(outputIdx).Values);
